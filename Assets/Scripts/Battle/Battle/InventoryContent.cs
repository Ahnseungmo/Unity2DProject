...
//            print(scrollSnap.SelectedPanel);
        ...
        public void Add(int index , Sprite sprite = null)
        {
            /*
            // Pagination
            ...
            */
            ...
            panelPrefab.GetComponent<Image>().sprite = sprite;
        ...
        public void AddToBack(Sprite sprite = null)
        {
            Add(scrollSnap.NumberOfPanels,sprite);
        }
